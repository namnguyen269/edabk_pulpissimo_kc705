...
#QSPI FLASH
set_property -dict {PACKAGE_PIN U19 IOSTANDARD LVCMOS33} [get_ports pad_uart_rst]
set_property -dict {PACKAGE_PIN R25 IOSTANDARD LVCMOS33} [get_ports pad_pmod0_5]
set_property -dict {PACKAGE_PIN R20 IOSTANDARD LVCMOS33} [get_ports pad_pmod0_6]
set_property -dict {PACKAGE_PIN R21 IOSTANDARD LVCMOS33} [get_ports pad_pmod0_7]
...
set_property -dict {PACKAGE_PIN R29 IOSTANDARD LVCMOS33} [get_ports pad_hdmi_sda]
set_property -dict {PACKAGE_PIN R26 IOSTANDARD LVCMOS33} [get_ports pad_pmod1_0]
set_property -dict {PACKAGE_PIN R30 IOSTANDARD LVCMOS33} [get_ports pad_pmod1_1]
set_property -dict {PACKAGE_PIN P29 IOSTANDARD LVCMOS33} [get_ports pad_pmod1_]
set_property -dict {PACKAGE_PIN T30 IOSTANDARD LVCMOS33} [get_ports pad_pmod1_3]
set_property -dict {PACKAGE_PIN AE24 IOSTANDARD LVCMOS33} [get_ports sdio_reset_o]
set_property -dict {PACKAGE_PIN R28 IOSTANDARD LVCMOS33} [get_ports pad_hdmi_clk]
