...
set_property -dict {PACKAGE_PIN AA12 IOSTANDARD LVCMOS15} [get_ports btnc_i]
set_property -dict {PACKAGE_PIN AG5 IOSTANDARD LVCMOS15} [get_ports btnd_i]
set_property -dict {PACKAGE_PIN AB12 IOSTANDARD LVCMOS15} [get_ports btnl_i]
set_property -dict {PACKAGE_PIN AC6 IOSTANDARD LVCMOS15} [get_ports btnr_i]
set_property -dict {PACKAGE_PIN G12 IOSTANDARD LVCMOS25} [get_ports btnu_i]
...
#set_property -dict {PACKAGE_PIN K23 IOSTANDARD LVCMOS25} [get_ports pad_uart_rts]
#set_property -dict {PACKAGE_PIN L27 IOSTANDARD LVCMOS25} [get_ports pad_uart_cts]
...
#set_property -dict {PACKAGE_PIN AE26 IOSTANDARD LVCMOS25} [get_ports ]
#set_property -dict {PACKAGE_PIN G19 IOSTANDARD LVCMOS25} [get_ports ]
#set_property -dict {PACKAGE_PIN E18 IOSTANDARD LVCMOS25} [get_ports ]
#set_property -dict {PACKAGE_PIN F16 IOSTANDARD LVCMOS25} [get_ports ]
...
set_property -dict {PACKAGE_PIN AA28 IOSTANDARD LVCMOS25} [get_ports switch2_i]
set_property -dict {PACKAGE_PIN Y28 IOSTANDARD LVCMOS25} [get_ports switch3_i]
